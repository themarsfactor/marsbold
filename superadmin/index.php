...
<title>:: Marsbold :: Super Admin | Dashboard</title>
...
<div id="main_content">
    ...
    <div id="left-sidebar" class="sidebar ">
        <h5 class="brand-name">Marsbold <a href="javascript:void(0)" class="menu_option float-right"><i class="icon-grid font-16" data-toggle="tooltip" data-placement="left" title="Grid & List Toggle"></i></a></h5>
